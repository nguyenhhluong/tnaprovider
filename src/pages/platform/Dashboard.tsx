...
import { DollarSign, Users, TrendingUp, Wrench, FileText, Activity } from "lucide-react";
...
export function Dashboard() {
  ...
  return (
    <>
      <PageHeader title="Dashboard" description="Overview of your business activity and key metrics." onMenuClick={() => setSidebarOpen(true)} />
      <div className="p-4 md:p-6 space-y-6">
        {loading ? (
          ...
          <>
            ...
            {activities.length === 0 && (
              <EmptyState icon={Activity} title="No recent activity" message="Recent actions will appear here as you use the platform." />
            )}
          </>
        )}
      </div>
